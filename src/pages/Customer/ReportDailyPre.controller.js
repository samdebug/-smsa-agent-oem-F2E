...
export default {
    ...
    mounted() {
        ...
        let start_date_arr = sessionStorage.getItem("yufustart").split("-");
        let end_date_arr = sessionStorage.getItem("yufuend").split("-");
        ...
        let smstype = sessionStorage.getItem("pre_smstype");
    ...
    methods: {
        ...
        getReportDailyList(val) {
            ...
            this.$store.dispatch("getReportDailyListPre");
        },
        goBack() {
            this.$router.go(-1);
        },
