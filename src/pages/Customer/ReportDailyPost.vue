    ...
    div.page-report-daily
        ...
        div.clearfix.search-box
            ...
            .table-search.fr.clearfix
                a(href="javascript:;", v-on:click="exportReport()",title="导出后付费客户每日消耗报表").fr.icon-btn
                    span.fa.fa-download
        ...
        .p-20
            el-table(:data="daily_list.list", style="width:100%", v-loading="loading", show-summary)
                ...
                el-table-column(prop="wait_send_num", label="待发送条数", min-width="110")
...
<script src="./ReportDailyPost.controller.js"></script>
